...
### 🗃️ Formatos de dados suportados
- **CSV único** (novo formato TMDB+IMDb merged — recomendado)
- **Dois CSVs** (formato TMDB 5000 clássico)
...
**a)** Baixe o dataset em:
[kaggle.com/datasets/ggtejas/tmdb-imdb-merged-movies-dataset](https://www.kaggle.com/datasets/ggtejas/tmdb-imdb-merged-movies-dataset)

**b)** Coloque o arquivo CSV na pasta `data/`:

```
imdb-dashboard/
└── data/
    └── tmdb_imdb_merged.csv   ← qualquer nome .csv com mais de 10 MB funciona
```
...
O projeto suporta o dataset público:

> **TMDB + IMDB Merged Movies Dataset**
> Autor: ggtejas | Kaggle
> Link: https://www.kaggle.com/datasets/ggtejas/tmdb-imdb-merged-movies-dataset
> ~400.000 filmes | CSV único | ~250 MB

O `data_loader.py` detecta automaticamente o schema do arquivo e traduz todos os campos para português — gêneros, idiomas e colunas técnicas são mapeados sem intervenção manual.
...
<div align="center">
  Feito com 🎬 pela <strong>Foundation Frame Studios</strong>
</div>
